<div class="max-w-[600px] bg-white p-10 md:p-14 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 mx-auto">
    <div class="text-center mb-10">
        <h1 class="text-3xl font-extrabold tracking-tight mb-4">Comece sua <span class="text-primary">jornada</span></h1>
        <p class="text-slate-500 font-medium">Crie sua conta gratuita e modernize sua gestão financeira em minutos.</p>
    </div>
    <form wire:submit="register" class="space-y-6">
        <div>
            ...
            <div class="relative">
                ...
                <input wire:model="name" class="form-input-custom pl-14 @error('name') error @enderror" placeholder="Como deseja ser chamado?" type="text"/>
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input wire:model="email" class="form-input-custom pl-14 @error('email') error @enderror" placeholder="seu@email.com.br" type="email"/>
            </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input wire:model="document" oninput="this.value = documentMask(this.value)" class="form-input-custom pl-14 @error('document') error @enderror" placeholder="00.000.000/0000-00" type="text"/>
            </div>
        ...
        <div class="flex items-start gap-3 py-2">
            ...
            <label class="text-sm text-slate-500 leading-relaxed font-medium" for="terms">
                Eu concordo com os <a class="text-primary font-bold hover:underline" href="#">Termos de Uso</a> e a <a class="text-primary font-bold hover:underline" href="#">Política de Privacidade</a> da FinPay.
            </label>
