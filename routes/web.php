...
// Google Auth (Accessible to both Guests and Authenticated users for Sudo Mode)
...
Route::post('/user/confirm-sudo-2fa', [AuthController::class, 'confirmSudo2FA'])->middleware(['auth'])->name('password.confirm.2fa');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::view('/settings', 'banking.settings.index')->middleware('password.confirm')->name('settings.index');
